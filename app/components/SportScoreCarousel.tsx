...
export const SportScoreCarousel: React.FC<SportScoreCarouselProps> = ({
  scores,
}) => {
          ...
          >
            ...
            >
              ...
              <View style={styles.teamsContainer}>
                <View style={styles.teamRow}>
                  ...
                  <Text style={styles.formText}>
                    {score.team1.current_form}
                  </Text>
                </View>

                <View style={styles.teamRow}>
                  <Image
                    source={{ uri: score.team2.logo }}
                    style={styles.teamLogo}
                  />
                  <Text
                    style={[
              ...
              <View style={styles.timeContainer}>
                <Text
                  style={[styles.timeText, score.is_live && styles.liveText]}
                >
